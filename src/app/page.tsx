...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/30 py-6 flex flex-col justify-center sm:py-12">
      <main className="container mx-auto px-4">
        <Card className="w-full max-w-3xl mx-auto shadow-2xl rounded-xl overflow-hidden">
          <CardHeader className="bg-primary text-primary-foreground text-center p-8">
            ...
            <CardTitle className="text-4xl font-extrabold">VTU Marks Navigator</CardTitle>
